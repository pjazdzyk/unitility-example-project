...
public class FluidValidators {
    ...
    public static <Q extends Unit> Validation<InvalidQuantity, PhysicalQuantity<Q>> requireNonNull(PhysicalQuantity<Q> physicalQuantity) {
    ...
    public static <Q extends Unit> Validation<InvalidQuantity, PhysicalQuantity<Q>> requireNotExceedMinimalLimit(PhysicalQuantity<Q> physicalQuantity, PhysicalQuantity<Q> minLimit) {
    ...
    public static <Q extends Unit> Validation<InvalidQuantity, PhysicalQuantity<Q>> requireNotExceedMaximumLimit(PhysicalQuantity<Q> physicalQuantity, PhysicalQuantity<Q> maxLimit) {
        double sourceUnitInBase = physicalQuantity.toBaseUnit().getValue();
    ...
    public static <Q extends Unit> Validation<InvalidQuantity, PhysicalQuantity<Q>> requirePositiveValue(PhysicalQuantity<Q> physicalQuantity) {
    ...
    @SafeVarargs
    private static <Q extends Unit> InvalidQuantity invalidPropertyForNull(PhysicalQuantity<Q>... inputArguments) {
        String message = "Null value passed as argument.";
        LOGGER.warn(message);
        return new InvalidQuantity(message, inputArguments);
    }

    private static <Q extends Unit> InvalidQuantity invalidPropertyForExceededMinLimit(PhysicalQuantity<Q> physicalQuantity, PhysicalQuantity<Q> minLimit) {
    ...
    private static <Q extends Unit> InvalidQuantity invalidPropertyForExceededMaxLimit(PhysicalQuantity<Q> physicalQuantity, PhysicalQuantity<Q> maxLimit) {
        String quantityName = physicalQuantity.getClass().getSimpleName();
    ...
    private static <Q extends Unit> InvalidQuantity invalidPropertyForNegativeValue(PhysicalQuantity<Q> physicalQuantity) {
